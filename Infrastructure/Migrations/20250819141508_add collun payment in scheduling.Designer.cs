...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20250819141508_add collun payment in scheduling")]
    partial class addcollunpaymentinscheduling
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.SportsCenterClients", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("IdSportCenter");

                    b.ToTable("SportsCenterClients", (string)null);
                });
            ...
            modelBuilder.Entity("Core.SportsCourtAppointments", b =>
                {
                    ...
                    b.Property<int?>("IdSportsCenterClient")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("IdSportsCenterClient");
            ...
            modelBuilder.Entity("Core.SportsCenterClients", b =>
                {
                    b.HasOne("Core.SportsCenter", "SportsCenter")
                        .WithMany("SportsCenterClients")
                        .HasForeignKey("IdSportCenter")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Core.SportsCourtAppointments", b =>
                {
                    b.HasOne("Core.SportsCenterClients", "SportsCenterClients")
                        .WithMany("SportsCourtAppointments")
                        .HasForeignKey("IdSportsCenterClient");
                    ...
                    b.Navigation("SportsCenterClients");
